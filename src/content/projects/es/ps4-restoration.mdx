...
<p align="center">
  <img width="75%" src={img1.src} alt="Distribución del ventilador interno sucio de PS4" />
</p>
...
<p align="center">
  <img width="75%" src={img2.src} alt="PS4 desmontada en estado sucio" />
</p>
<p align="center">
  <img width="75%" src={img3.src} alt="Polvo expuesto en la placa base de PS4" />
</p>
...
<p align="center">
  <img width="75%" src={img4.src} alt="Estado de la pasta térmica limpia" />
</p>
...
<p align="center">
  <img width="75%" src={img5.src} alt="Pasta térmica Arctic MX-4 aplicada" />
</p>
<p align="center">
  <img width="75%" src={img6.src} alt="Ventilador interno y componentes limpios" />
</p>
...
<p align="center">
  <img width="75%" src={img7.src} alt="Versión base de firmware antiguo 8.50" />
</p>
...
## Resultado Final
<p align="center">
    <img width="75%" src={img8.src} alt="Menú de configuración de PlayStation 4 mostrando el estado de GoldHEN" />
</p>

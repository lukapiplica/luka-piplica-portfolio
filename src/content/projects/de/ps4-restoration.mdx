...
* **Manuelles Firmware-Upgrade:** Konstruktion einer strikt vorgegebenen statischen Ordnerstruktur (`/PS4/UPDATE/PS4UPDATE.PUP`) na jednom exFAT-formatierten Blockspeichermedium, gefolgt vom Staging und Deployment eines offiziellen 9.00-Recovery-Systempartition-Images über einen lokalen Medien-Boot.
